...
class AnalytiqueController extends Controller
{
    ...
    { 
        ...
        return view("dashboard.projets.plan_analytique.liste", [
    ...
    public function store(Request $request)
    {
        ...
        $type->structure_pa = 0;
        $type->projet_pa = session('id_projet');
        ...
        return redirect()->route('plans_analytique.index');
    }
