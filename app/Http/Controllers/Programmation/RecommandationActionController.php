...
class RecommandationActionController extends Controller
{ /**
   ...
   {
       $recommandation = new RecommandationAction();
       $recommandation->resume_rma = $request->resume;
       $recommandation->intitule_rma = $request->intitule;
       $recommandation->code_rma = $request->code; 
       $recommandation->date_butoir_rma = $request->date_butoir;
       $recommandation->type_recommandation_rma = $request->type;
       $recommandation->structure_concerne_rma = $request->structure;
   ...
   {
       $type=RecommandationAction::find($ids);
