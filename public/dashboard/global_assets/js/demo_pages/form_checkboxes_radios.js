...
var InputsCheckboxesRadios = function () {
    ...
    var _componentSwitchery = function() {
        ...
        var switchery = primary ? new Switchery(primary, { color: '#2196F3' }) : null;

        var danger = document.querySelector('.form-check-input-switchery-danger');
        var switchery = danger ? new Switchery(danger, { color: '#EF5350' }) : null;

        var warning = document.querySelector('.form-check-input-switchery-warning');
        var switchery = warning ? new Switchery(warning, { color: '#FF7043' }) : null;

        var info = document.querySelector('.form-check-input-switchery-info');
        var switchery = info ? new Switchery(info, { color: '#00BCD4'}) : null;
    };
