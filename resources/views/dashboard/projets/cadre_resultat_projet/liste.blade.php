    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        ...
        <div class="header-elements d-none">
            <div class="breadcrumb justify-content-center">
                <a href="#" class="btn bg-teal-400 text-white btn-block btn-war mb-1 mt-1"  data-toggle="modal" data-target="#modal_niveau">
        ...
        <div class="col-12 mb-4">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 btn-group"> 
                    @foreach ($niveau_cadres as $item)
                    <label class="btn btn-outline-secondary">
                      <a href="{{ route('cadre_resultat_projet.show', $item->id_ncrp ) }}" class="nav-link active " >
                      <i class="icon-menu7 mr-2"></i>{{ $item->libelle_ncrp }}
                    </a>
                    </label>
                      @endforeach
