                                ...
                                <tbody>
                                    @if (isset($indicateur))
                                     ...
                                     <tr style="background-color: #4e4b4b7d">
                                        <th colspan="3" >{{ $resultat->intitule_iprg }}(<samp style="color: red"><b> {{ $resultat->valeur_cible_iprg }}</b></samp>)</th>
                                        <td class="text-center">
                                            <a href="" class=" indicateur_ajout" id="{{ $resultat->id_iprg }}"   data-placement="bottom" title="Ajout">
        ...
        <div id="modal_indic" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <form class="modal-content" method="POST" action="{{ route('suivi_indicateur_pp.store') }}">
                    ...
                    <input type="hidden" class="form-control" value="programme" id="pro_projet" name="pro_projet" aria-describedby="sigle">
