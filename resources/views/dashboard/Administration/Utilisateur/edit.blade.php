...
<div class="page-header-content header-elements-md-inline">
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-item">Uilisateurs</span>
             <span  style="font-size: 16px;color:#e79300;" class="breadcrumb-item active">Modifier un utilisateur</span>
         </div>
    </div>
    <div class="header-elements d-none py-0 mb-3 mb-md-0">
        <span class="h5 fw-bolder text-black">Modifier l'utilisateur : {{ $user->nom. ' ' .$user->prenom }}</span>
    </div>
</div>
@endsection
...
<div class="card p-4">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-sm-12">                
            ...
            @endif
            <form class="row" id="add" action="{{ route('user.update', $user) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="inputEmail4" class="text-black">Profil <span class="text-danger text-bold">*</span></label>
                        <select class="form-control select @error('profil_id') is-invalid @enderror" name="profil_id" aria-describedby="profil_id" placeholder="Sélectionner le profil">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('nom') is-invalid @enderror" id="nom" name="nom" aria-describedby="nom" placeholder="Saississez le nom de l'utilisateur" value="{{ $user->nom }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="inputEmail4" class="text-black">Prénom <span class="text-danger text-bold">*</span></label>
                        <input type="text" class="form-control @error('prenom') is-invalid @enderror" id="prenom" name="prenom" aria-describedby="prenom" placeholder="Saississez le prénom de l'utilisateur" value="{{ $user->prenom }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <label for="inputEmail4" class="text-black">Email <span class="text-danger text-bold">*</span></label>
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" aria-describedby="email" placeholder="Saississez l'email de l'utilisateur" value="{{ $user->email }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('telephone') is-invalid @enderror" id="telephone" name="telephone" aria-describedby="telephone" placeholder="Saississez le numéro" value="{{ $user->telephone }}" >
