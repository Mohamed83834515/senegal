...
<div class="page-header-content header-elements-md-inline">
    <div class="d-flex">
        <div class="breadcrumb">
                ...
                <span  style="font-size: 16px;color:#e79300;" class="breadcrumb-item active">Modifier un module</span>
         </div>
    </div>

    <div class="header-elements d-none py-0 mb-3 mb-md-0">
        <span class="h5 fw-bolder text-black">Modifier le module : {{ $module->libelle }}</span>
    </div>
</div>
@endsection
