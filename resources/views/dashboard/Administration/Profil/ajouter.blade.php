                ...
                <form class="row" id="add" action="{{ route('profil.store') }}" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select @error('modules') is-invalid @enderror" name="modules[]" aria-describedby="modules" data-placeholder="choisissez les modules" multiple>
