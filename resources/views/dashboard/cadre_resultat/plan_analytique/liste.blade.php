    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="#" class="breadcrumb-item">Parametrage</a>
...
<div class="d-flex align-items-start flex-column flex-md-row">
    ...
    <div class="w-100 overflow-auto order-2 order-md-1">
            ...
            <div class="nav-tabs-responsive bg-light border-top">
                <ul class=" card-title nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
                    ...
                    @foreach ($niveau_cadres as $item)
                       <li class="nav-item">
                        <a href="{{ route('plan_analytique.show', $item->niveau_npa ) }}" class="nav-link " >
                    ...
                    <li class="nav-item">
                        {{-- mb-1 mt-1 --}}
                    <a href="#" class="btn bg-teal-400 btn-block" data-toggle="modal" data-target="#modal_iconified">
                    <i class="icon-add mr-2"></i>
                    Ajouter un plan analytique
                    @if($id==1)
                         ...
                         @foreach ($type as $region)
                            <tr>
                                ...
                                @if(isset($region->parent))
                                    <td >{{ $region->parent->intitule_pa }}</td>
                                @endif
                ...
                <form class="modal-content" id="editform" action="" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                           ...
                           <div class="col-md-12 mb-2">
                            <label for="inputEmail4" class="text-black">Code correspondance </label>
        ...
        <div id="modal_iconified" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <form class="modal-content" method="POST" action="{{ route('plan_analytique.store') }}">
                    @csrf
                    @method('POST')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <br>
                        <form class="" method="POST" action="{{ route('niveau_plan_analytique.store') }}">
                            @csrf
                            @method('POST')
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','.modaledit',function(){
           ...
           var lien="./plan_analytique_edit/"
           var lien1="../plan_analytique_edit/"
           var liena='./plan_analytique_update/'
           var liena1='../plan_analytique_update/'
           ...
           $.ajax({
                ...
                success: function (response) {
                    if(response.cadre.id_niv_pa==1)
                    {
                       console.log(response.cadre.id_niv_pa); 
                    }
                    else
                    {
                        console.log("bonjour");
    ...
    $(document).on('click','.modaleditniveau',function(){
           ...
           var lien="./niveau_plan_analytique_edit/"
           var lien1="../niveau_plan_analytique_edit/"
           var liena='./niveau_plan_analytique_update/'
           var liena1='../niveau_plan_analytique_update/'
            var statut=$(this).attr("statut");
