    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="#" class="breadcrumb-item"> Indicateurs Projet</a>
            </div>
            ...
            <form class="modal-content" id="editform" action="" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            <label for="inputEmail4" class="text-black">Indicateurs<span class="text-danger text-bold"></span></label>
        ...
        <form class="modal-content" method="POST" action="{{ route('indicateur_projet.store') }}">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-6">
                        <label for="inputEmail4" class="text-black">Indicateurs PCGAP II <span class="text-danger text-bold"></span></label>
                        <select class="form-control select " id="indicateurpcga" name="indicateurpcga" data-placeholder="choisissez les types" >
                            <option>--Choisissez--</option>
                            @foreach ($indic as $typ)
