@extends('dashboard.layouts.dashboard', ['title' => 'Modifier la thématique'])
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item">Thématiques</span>
                <span class="breadcrumb-item active">{{ $thematique->nom_tmq }}</span>
            </div>
...
<div class="card p-4">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-sm-12">
            ...
            <form class="row" id="add" action="{{ route('thematique.update', $thematique) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="col-md-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('nom') is-invalid @enderror" id="nom" name="nom" aria-describedby="nom" placeholder="Saississez le nom" value="{{ $thematique->nom_tmq }}" required>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group mb-3">
                        ...
                        <textarea type="text" class="form-control" name="description" aria-describedby="description">{{ $thematique->description_tmq }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 mb-4">
                    <div class="form-group mb-3">
                        ...
                        <div class="col-lg-12">
                            <input type="file" class="file-input" name="photo" value="{{ $thematique->photo_tmq }}" data-fouc>
