@extends('dashboard.layouts.dashboard', ['title' => 'Modifier type de programme'])
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">{{ $type_programme->nom_tpr }}</span>
            </div>
...
<div class="card p-4">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-sm-12">
            ...
            <form class="row" id="add" action="{{ route('type_programme.update', $type_programme) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-12 mb-2">
                                <label for="inputEmail4" class="text-black">Nom <span class="text-danger text-bold">*</span></label>
                                <input type="text" class="form-control" id="nom" name="nom" placeholder="" value="{{ $type_programme->nom_tpr }}"  aria-describedby="code" placeholder="" required>
                            </div>

                            <div class="col-md-12 mb-4">
                                <label for="inputEmail4" class="text-black">Description <span class="text-danger text-bold"></span></label>
                              <textarea type="text" class="form-control" name="description" aria-describedby=""  >{{ $type_programme->description_tpr }}</textarea>
                            </div>
