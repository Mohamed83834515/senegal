@extends('dashboard.layouts.dashboard', ['title' => 'Modifier unité indicateur'])
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item">Unité indicateur</span>
                <span class="breadcrumb-item active">{{ $unite->nom_uti }}</span>
            </div>
...
<div class="card p-4">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-sm-12">
            ...
            <form class="row" id="add" action="{{ route('unite.update', $unite) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-12 mb-2">
                                <label for="inputEmail4" class="text-black">Nom de l'Unité <span class="text-danger text-bold">*</span></label>
                                <input type="text" class="form-control" id="code" name="code" placeholder="Reveil" value="{{ $unite->code_uti }}"  aria-describedby="code" placeholder="Saississez le code" required>
                            </div>

                            <div class="col-md-12 mb-4">
                                <label for="inputEmail4" class="text-black">Définition <span class="text-danger text-bold"></span></label>
                              <textarea type="text" class="form-control" name="nom" aria-describedby="sigle"  >{{ $unite->nom_uti }}</textarea>
                            </div>
