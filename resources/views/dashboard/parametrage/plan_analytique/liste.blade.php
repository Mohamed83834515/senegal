            ...
            <div class="nav-tabs-responsive bg-light border-top">
                <ul class=" card-title nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
                    ...
                    @foreach ($niveau_cadres as $item)
                       <li class="nav-item">
                        <a href="{{ route('plan_analytique.show', $item->id_npa ) }}" class="nav-link" >
                ...
                <div class="tab-pane fade show active" id="region">
                    ...
                    <table class="table table-striped datatable-responsive datatable-header-basic" id="DataTables_Table_0">
                        ...
                        <tr>
                            ...
                            <th>Code</th>
                            @php
                            $type = $niveau->where('id_npa', '=', $id-1)->first();
                            $type2 = $niveau->where('id_npa', '=', $id)->first();
                        ...
                        <tbody>
                        @php
                            $type = $cadre_logique->where('id_niv_pa', '=', $id);
                        @endphp
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3 mb-2">
                                <input type="text" class="form-control" id="taille" name="taille" placeholder="Taille du code" required>
                            </div>
                        </div>
                        <br>
                        <div class="modal-footer">
