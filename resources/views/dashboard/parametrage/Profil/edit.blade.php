...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <div class="mb-3">
            ...
            <span class="text-muted d-block">
                ...
                <span class="breadcrumb-item active">Modifier un profil</span>
            </span>
        </div>
    ...
    <div class="header-elements d-none py-0 mb-3 mb-md-0">
        <span class="h4 text-black ">Modifier le profil : {{ $profil->libelle }}</span>
    </div>
            ...
            <form class="row" id="add" action="{{ route('profil.update', $profil) }}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control select @error('modules') is-invalid @enderror" name="modules[]" aria-describedby="modules" multiple>
